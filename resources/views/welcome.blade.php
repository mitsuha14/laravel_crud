...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="bg-gray-50 text-black/50">
            <img id="background" class="absolute" src="https://images.hdqwalls.com/wallpapers/anime-schoolgirl-walking-barefoot-by-the-seaside-fc.jpg" />
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="https://liveloveapp.com/assets/logo/ngrx.svg" alt="Your Image Description" class="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]">
                        </div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        src="https://images.hdqwalls.com/wallpapers/anime-schoolgirl-walking-barefoot-by-the-seaside-fc.jpg"
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">CRUD</h2>

                                    <p class="mt-4 text-sm/relaxed">

                                        An acronym combining Create, Read, Update, Delete, signifies the basic operations for managing and interacting with news content
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">CRUD News</h2>
